...
<nav class="teal darken-3" role="navigation">
            <div class="nav-wrapper container"><a id="logo-container" href="../employees/index.php" class="brand-logo"><img class="responsive-img" style="max-height:60px;" src="../images/logo.png" alt=""></a>
                <ul class="right hide-on-med-and-down">
                    <li><a href="../employees/index.php">Dashboard</a></li>
                    ...
                    <li><a class="dropdown-trigger white-text" href="customer_list.php" data-target="customer_dropdown">Customer</a></li>
                    ...
                    <li><a class="dropdown-trigger white-text" href="category_list.php" data-target="category_dropdown">Category</a></li>
                    ...
                    <li><a class="dropdown-trigger white-text" href="./employee_profile.php" data-target="employee_dropdown">Profile</a></li>
                    <li><a href="./logout.php">Logout</a></li>
                </ul>

                <ul id="nav-mobile" class="sidenav" style="background-color:#00695c;">
                  <li><a href="../employees/index.php"style="color:white">Dashboard</a></li>
                  ...
                  <li><a class="dropdown-trigger white-text" href="customer_list.php" data-target="dropdown2">Customer</a></li>
                    <ul id='dropdown2' class='dropdown-content'>
                      <li><a href="add_customer.php" class="teal-text text-darken-3"><i class="material-icons" style="color:#00695c;">person_add</i>Add Customer</a></li>
                      <li><a href="customer_list.php" class="teal-text text-darken-3"><i class="material-icons" style="color:#00695c;">list</i>Customer List</a></li>
                    </ul>
                  <li><a class="dropdown-trigger white-text" href="category_list.php" data-target="dropdown3">Category</a></li>
